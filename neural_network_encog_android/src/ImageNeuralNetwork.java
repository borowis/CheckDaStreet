...
{
    private final String NEURAL_NETWORK_FILE_NAME = "network.txt";
    private final String NEURAL_NETWORK_IDENTITY = "identity2neuron.txt";
    ...
    private AndroidImageMLDataSet training;
    private String                line;
    ...
    private void processCreateTraining() {
        ...
        this.training = new AndroidImageMLDataSet(this.downsample, false, 1, -1);
    }
    ...
    private void processNetwork() throws IOException {
        ...
        AndroidImageMLDataSet imageDataSet = this.training;
...
//        );
    ...
    {
        File network = new File(NEURAL_NETWORK_FILE_NAME);
        if (!network.exists())
            throw new IllegalArgumentException("network description file doesn't exist!");
        File identity2neuron = new File(NEURAL_NETWORK_IDENTITY);
